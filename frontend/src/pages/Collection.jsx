...
// __________________________________________22222nd TRY
...
//   const [sortType, setSortType] = useState("relevant");
//   const [loading, setLoading] = useState(true);
//   const [isProductsLoaded, setIsProductsLoaded] = useState(false); // NEW
...
//   // Track when products first load
//   useEffect(() => {
//     if (products && products.length > 0) {
//       setIsProductsLoaded(true); // Mark products as loaded
//       setLoading(true); // Start loading filtered results
//       const timeout = setTimeout(() => {
//         applyFilter(products);
//         setLoading(false);
//       }, 300); // Optional delay to show skeleton briefly
